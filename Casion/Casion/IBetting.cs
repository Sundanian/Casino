...
namespace Casion
{
    interface IBetting
    {
        ...
        int BetSplit(int bet, int placementOfBet, int secondPlacementBet, int randomNumber); //Sats på 2 numre på én gang (1-2, 2-3, ect..)
        int BetStreet(int bet, int placementOfBet, int randomNumber); //Sats på 3 numre på én gang (1-2-3, 4-5-6, ect..)
        int BetCorner(int bet, int placementOfBet, int secondPlacementBet, int randomNumber); //Sats på 4 numre på én gang (1-2-4-5, 2-3-5-6, ect..)
        int BetFive(int bet, int placementOfBet, int randomNumber); //Sats på 5 numre på én gang (KUN, 0-00-1-2-3)
        int BetLine(int bet, int placementOfBet, int secondPlacementBet, int randomNumber); //Sats på 6 numre på én gang (1-2-3-4-5-6, 4-5-6-7-8-9, ect..)3
